                        ...
                        <div className='d-flex justify-content-between align-items-center'> 
                            <div className='d-flex justify-content-start align-items-center gap-3 text-sm'>
                                <h1 className='m-auto display-6'>
                                    {obscureLabel(this.props.domain.name, 25)}
                                    &nbsp;
                                    { (this.props.domain.tags.includes("include-unicode") || this.props.domain.tags.includes("only-unicode")) && 
                            ...
                            <div className="row g-0"> 
                                ...
                                <div className='col-lg-8'>
                                    <div className="card-body m-0 m-lg-1 m-md-1 m-sm-0"> 
                                        { isValidName(this.props.domain.label) === false &&
