                ...
                <div className="card-body">
                    <div className="row">
                        <div className="col-md-12 mb-3"> 
                            <div className="input-group input-group-lg d-flex flex-row gap-2">
                                ...
                                <select className="form-select flex-shrink-1" defaultValue="expires">
                        ...
                        <div className="col-md-3 mb-3 " >
                            <div className="card collapse-horizontal overflow-auto" id="filters" >
                                <div className="card-header d-flex flex-row justify-content-between">
                                    <button className="btn fs-5 p-0 m-0" data-bs-toggle="collapse" >Filter</button> 
                                    <button className="btn border-0" type="button" data-bs-toggle="collapse" onClick={handleFilterClick} >
