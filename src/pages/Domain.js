...
import {getTokenId, obscureString } from '../helpers/String'
            ...
            <div className="container p-3 text-white">
                <div className='d-flex justify-content-between align-items-center'> 
                    <div className='d-flex justify-content-start align-items-center gap-3'>
                        <h1 className='m-auto'>{obscureString(domain.name, 50)}</h1>
                        <a target="_blank" href={ ETHERSCAN_URL.replace("{REACT_APP_ENS_REGISTRAR_ADDRESS}", ENS_REGISTRAR_ADDRESS).replace("{TOKEN_ID}", getTokenId(domain.label))} title="View on Etherscan" data-bs-toogle="tooltip" data-bs-title="asklfdja" className='text-white'>
                            ...
                            <div className='img-container img-fluid p-0 m-0 img-thumbnail border-1 shadow-sm border-warning d-inline-flex align-items-center img-responsive'>
                                <div className='text-center m-auto'>
                                    <LazyLoadImage
                                        ...
                                        /> 
                                    <h2 className='text-white fs-1'>{obscureString(domain.label, 20)}.eth</h2>
                                </div> 
                            </div> 
                        </div>
                        <div className='col-lg-7'>
                            <div className="card-body">
                                ...
                                <ul className='list-group list-group-flush'>
                                    <li className='list-group-item border-0 p-0 pb-3'>
                                        <span className='fw-bold fs-5'>Tags </span> <span className='float-end'>{domain.tags.join(", ")}</span>
                                    </li>
                                    <li className='list-group-item border-0 p-0 pb-3'>
                                    ...
                                    <span className='fw-bold fs-5'>Token ID </span> <span className='float-end'>{obscureString(getTokenId(domain.label), 25)}</span>
                                    </li>
                                    <li className='list-group-item border-0 p-0 pb-3'>
                                        <span className='fw-bold fs-5'>Length </span> <span className='float-end'>{domain.length}</span>
                                    </li>
                                    <li className='list-group-item border-0 p-0 pb-3'>
                                        <span className='fw-bold fs-5'>Segment Length </span> <span className='float-end'>{domain.segmentLength}</span>
                                    </li>
                                    <li className='list-group-item border-0 p-0 pb-3'>
                                        <span className='fw-bold fs-5'>Created Date </span> <span className='float-end'>{moment.unix(domain.created).toDate().toDateString()}</span>
                                    </li>
                                    <li className='list-group-item border-0 p-0 pb-3'>
                                        <span className='fw-bold fs-5'>Registered Date </span> <span className='float-end'>{moment.unix(domain.registered).toDate().toDateString()}</span>
                                    </li>
                                    <li className='list-group-item border-0 p-0 pb-3'>
                                        <span className='fw-bold fs-5'>Expires Date </span> <span className='float-end'>{moment.unix(domain.expires).toDate().toDateString()}</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
