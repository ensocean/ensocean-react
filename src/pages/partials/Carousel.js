            ...
            <div id="carouselhome" className="carousel slide">
                ...
                <div className="carousel-inner"> 
                    <div className="carousel-item active pt-5 pb-5 mt-4 mb-4">
                        ...
                        <h2 className="display-4">Catch Dropped ENS Domains</h2>
                ...
                <div className="carousel-item pt-5 pb-5 mt-4 mb-4"> 
                    ...
                    <p className="lead">
                        <a className="btn btn-primary btn-lg btn-warning" href="/find" role="button">Find Now</a>
                    </p>
                    </div> 
                </div>
                ...
                <div className="carousel-item pt-5 pb-5 mt-4 mb-4">
                    ...
                    <p className="lead">Having trouble finding a name? We encourage you to browse over millions of ENS domains and make an offer to the owner.</p>
                    <p></p>
                    <p className="lead">
                        <a className="btn btn-primary btn-lg btn-warning" href="/discover" role="button">Browse</a>
                    </p>
                    </div>
                </div> 
                -->*/ }
