...
const Footer = () => {
    return (
        <>
            <div class="container-fluid bg-primary p-3 text-center text-white fs-6 mt-5">
                #DeepDiveIntoENS
            </div>
            <div class="footer bg-dark pt-4 text-white">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                            <img src={logo} alt="EnsOcean" class="float-start me-1" />
                            <h3>EnsOcean</h3>
                            <p>
                        ...
                        <div class="col-lg-6">
                            <ul class="list-inline list-unstyled float-lg-end float-sm-none">
                            <li class="list-inline-item"> 
                                <a href="https://opensea.io/EnsOceanOfficial" target="_blank" rel="noopener" title="View EnsOcean on Opensea">
                                    <svg width="32" height="32" fill="white" class="bi bi-opensea" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 90 90">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <small class="text-muted">Made with <span class="text-danger">♥</span> © 2022 EnsOcean.</small>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <ul class="list-inline list-unstyled float-lg-end float-md-end float-sm-none">
                        <li class="list-inline-item"><Link to="/privacy" title="Privacy Policy"><small>Privacy</small></Link></li>
                        <li class="list-inline-item"><Link to="/terms" title="Term Of Use"><small>Terms</small></Link></li>
                        <li class="list-inline-item"><Link to="/faq" title="Frequently Asked Questions"><small>FAQ</small></Link></li>
                        <li class="list-inline-item"><a href="https://medium.com/the-ethereum-name-service" target="_blank" title="Learn ENS"><small>Learn ENS</small></a></li>
                        </ul>
                    </div>
                    </div>
                </div>
